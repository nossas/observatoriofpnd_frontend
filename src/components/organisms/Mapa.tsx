...
const extents = {
    "default": [-73.79487377262059, -16.29340772910929, -46.600017512173174, 4.3929018134876925],
    "AM": [-73.40382673020356, -9.66692010668144, -56.651074667511395, 0.717678199618431],
    "RO": [-66.80343861008828, -13.67121292568953, -60.08077887914084, -7.975927522993186],
    "PA": [-58.24996568369845, -9.591853023885147, -46.600017512173174, -0.7190817437694077],
...
export const Mapa = () => {
    ...
    useEffect(() => {
        if (mapRef.current ) {
            ...
            //@ts-ignore
            extent = [...fromLonLat([extent[0], extent[1]]), ...fromLonLat([extent[2], extent[3]])]
